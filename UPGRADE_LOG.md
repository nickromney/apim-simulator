...
- Notes:
  - `astro@6.1.6` was published too recently for the repo's seven-day npm age gate, so `examples/todo-app/frontend-astro/.npmrc` was temporarily set to `min-release-age=0` for the roll-forward.
